...
probability:
\begin{equation}\label{post_covid_lec2}
...
likelihood: 
\begin{equation}\label{likeli_lec2}
...
\left(-\frac{(x_i - 
      \theta)^2}{2 \sigma^2} \right). 
\end{align}
This leads to the likelihood \eqref{likeli_lec2} (note that $\delta^n$ is
